    ...
    <header class="header-v3">
            ...
            <div class="wrap-menu-desktop">
                <nav class="limiter-menu-desktop p-l-45">
                    ...
                    <a href="{{url('/')}}" class="logo">
                        <img src="{{asset('assets/site/images/icons/logo-02.png')}}" alt="IMG-LOGO">
                    </a>
                    ...
                    <div class="wrap-icon-header flex-w flex-r-m h-full">
                        <div class="flex-c-m h-full p-r-25 bor6">
                            ...
                            <div class="dropdown">
                                <button class="btn dropdown-toggle text-white icon-header-item cl0 hov-cl1 trans-04 p-lr-11" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="icon-header-item cl0 hov-cl1 trans-04 p-lr-11 icon-header-noti js-show-cart" data-notify="{{session()->has('cart')? session('cart')->getTotalQty() : 0 }}">
        ...
        <div class="wrap-header-mobile">
            ...
            <div class="logo-mobile">
                <a href="index.html"><img src="{{asset('assets/site/images/icons/logo-01.png')}}" alt="IMG-LOGO"></a>
            </div>
...
@else
    ...
    <header class="header-v4">
        ...
        <div class="wrap-header-mobile">
            <!-- Logo moblie -->
            <div class="logo-mobile">
                <a href="{{route('welcome')}}"><img src="{{asset('assets/site/images/icons/logo-01.png')}}" alt="IMG-LOGO"></a>
            </div>
